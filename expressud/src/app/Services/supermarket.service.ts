...
export class SupermarketService {
  getAllsupersBySearchTerm: any;
  getAllsupersByTag: any;
  ...
  getAllSUPERMARKETsBySearchTerm(searchTerm: string) {
  ...
  getAllSUPERMARKETsByTag(tag: string): Observable<Super[]> {
    return tag === "All" ?
      this.getAll() :
      this.http.get<Super[]>(SUPERMARKETS_BY_TAG_URL + tag);
  }

  getSUPERMARKETById(superId:string):Observable<Super>{
